...
import com.solanteq.solar.plugin.converter.generateDsl
...
import com.solanteq.solar.plugin.converter.schema.action.InlineAction
...
import com.solanteq.solar.plugin.element.form.FormInline
...
class ExpressionTest : LightPluginTestBase() {
    ...
    @Test
    fun `ExpressionAware getExpressions - multiple expressions returned 2`() {
        fixture.createForm(
            "rootForm1", "abc", """
            {
              "groups": "json://includes/forms/abc/groups.json",
        ...
        val objectAtCaret = fixture.file.findElementAt(fixture.caretOffset)!!.parent as JsonElement
//        val formElement = FormInline.createFrom(objectAtCaret)!!

//        val result = formElement.l10nKeys
