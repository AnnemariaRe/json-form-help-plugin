...
import com.solanteq.solar.plugin.converter.schema.action.AbstractCustomAction
import com.solanteq.solar.plugin.converter.schema.action.CustomAction

class CustomActionDeserializer : StdDeserializer<AbstractCustomAction>(
    AbstractCustomAction::class.java) {
